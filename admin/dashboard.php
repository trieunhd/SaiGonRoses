...
$users = get($conn, "select * from thanh_vien");
$tongsp = get($conn, "select * from san_pham");
$spban = get($conn, "select * from lsgiaodich");
$spban_wait = get($conn, "select * from lsgiaodich where status = '0'");
$spban_transport = get($conn, "select * from lsgiaodich where status = '1'");
$spban_done = get($conn, "select * from lsgiaodich where status = '2'");
$spban_faild = get($conn, "select * from lsgiaodich where status = '3'");
$spban_today = get($conn, "select * from lsgiaodich  where thoigian like '%$date'");

$query = mysqli_query($conn, "select * from thanh_vien");
$query1 = mysqli_query($conn, "select * from lsgiaodich  where status = '0'");
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div>
                                        <h3 class="text-danger"><?php echo $users; ?></h3>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="align-self-center">
                                        <i class="fas fa-newspaper text-info fa-3x"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div class="text-end">
                                        <h3><?php echo $spban ?></h3>
                                        <p class="mb-0">Tổng đơn</p>
                                    </div>
                                    <div class="align-self-center">
                                        <i class="far fa-calendar-alt text-primary fa-3x"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div class="text-end">
                                        <h3><?php echo $spban_today ;?></h3>
                                        <p class="mb-0">Đơn hôm nay</p>
                                    </div>
                                    <div class="align-self-center">
                                        <i class="far fa-bell text-danger fa-3x"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div class="text-end">
                                        <h3><?php echo $spban_wait ?></h3>
                                        <p class="mb-0">Đơn chờ duyệt</p>
                                    </div>
                                    <div class="align-self-center">
                                        <i class="fas fa-clipboard-list text-success fa-3x"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div class="text-end">
                                        <h3><?php echo $spban_transport ?></h3>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div class="text-end">
                                        <h3><?php echo $spban_done ?></h3>
                                        <p class="mb-0">Đơn thành công</p>
                                    </div>
                                    <div class="align-self-center">
                                        <i class="fa fa-check text-info fa-3x"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div>
                                        <h3 class="text-danger"><?php echo $spban_faild; ?></h3>
                                        <p class="mb-0">Đơn thất bại</p>
                                    </div>
                                    <div class="align-self-center">
